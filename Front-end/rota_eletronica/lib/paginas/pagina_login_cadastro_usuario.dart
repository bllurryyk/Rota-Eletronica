...
class PaginaLoginCadastroUsuario extends StatefulWidget {
  const PaginaLoginCadastroUsuario({super.key});

  @override
  State<PaginaLoginCadastroUsuario> createState() =>
      _PaginaLoginCadastroUsuarioState();
}

class _PaginaLoginCadastroUsuarioState
    extends State<PaginaLoginCadastroUsuario> {
  @override
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        Text(
          "Encontre os melhores lugares para descartar seu lixo eletrônico",
